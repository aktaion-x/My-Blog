...
export function Links() {
  return (
    <>
      <li className='relative text-zinc-400 transition-colors hover:text-zinc-50 w-fit'>
      ...
      <li className='relative text-zinc-400 transition-colors hover:text-zinc-50 w-fit'>
        ...
        <Link target='_blank' href='http://ghassan-athamin.site/'>Portfolio</Link>
      </li>
      <li className='relative text-zinc-400 transition-colors hover:text-zinc-50 w-fit'>
        <ArrowUpRightIcon className='absolute w-2 -right-2 top-1' />
        <Link target='_blank' href='https://github.com/aktaion-x'>Github</Link>
      </li>
